...
/**
 * 拦截器通过AroundInterceptor接口实现，类似于代理的机制
 * SpanEventSimpleAroundInterceptorForPlugin 比 AroundInterceptor 接口 多出两个 doInBeforeTrace 和 doInAfterTrace 多出了SpanEventRecorder参数，
 * 通过参数可以实现链路的跟踪上报功能
 */
